...
![Panel kontroli wersji w VS Code](images/source-control-panel.svg)
...
![Wpisywanie wiadomości i zatwierdzanie zmian](images/commit-operation.svg)
...
![Przycisk synchronizacji zmian na dolnym pasku](images/sync-changes.svg)
